...
module load OPENMPI/openmpi-1.6.2_gcc
   ...
   for i in range(0, nb_runs):
      for e in exps:
         ...
         f.write(tpl
                 ...
                 .replace("@ppn", ppn)
                 .replace("@exec", mpirun + ' ' +directory + '/' + e))
         f.close()
...
def launch_exp(conf_file):
   ...
   try:
      ...
      os.system('cp ' + 'build/default/' + exp + ' ' + directory + '/bin/' + exe + '_opt')
      os.system('cp ' + 'build/debug/' + exp + ' ' + directory + '/bin/' + exe + '_debug')
      print conf
      print directory
