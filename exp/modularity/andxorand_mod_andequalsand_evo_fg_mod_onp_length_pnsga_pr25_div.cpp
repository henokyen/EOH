...
#define PR25
#define DIV
#line 1 "/home/hmengist/sferes/sferes2/trunk/exp/modularity/andxorand_mod_andequalsand_evo.cpp"
#include <iostream>
#include <bitset>
#include<algorithm>
...
//	}
   ...
   //optimal length
      //bool write_svg = (this->mode() == fit::mode::view);
    //std::string fname="/project/EvolvingAI/hmengist/7.25/andxorand_mod/fgmod/nn"+_postFix+".svg";
...
for (it =results.begin();it!=results.end();++it)
    ...
    sol.open("/project/EvolvingAI/hmengist/7.25/andxorand_mod/fgmod/solvent.txt",std::fstream::out | std::fstream::app);
    sol <<"nn"+_postFix<<" "<<results.size()/number_problems<<"\n";
    sol.close();
    std::ofstream ofs("/project/EvolvingAI/hmengist/7.25/andxorand_mod/fgmod/nn"+_postFix+".dot");
    indiv.nn().write(ofs);
