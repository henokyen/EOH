...
#define PR25
#define DIV
#line 1 "/home/hmengist/sferes/sferes2/trunk/exp/modularity/andxorand_hier.cpp"
#include <iostream>
#include <bitset>
#include<algorithm>
...
#endif
#ifdef HE
      this->_objs.push_back(1-_grc);// minimizing hierarchy 
#endif
      // length
...
//	}
   ...
   //optimal length
     bool write_svg = (this->mode() == fit::mode::view);
    std::string fname="/project/EvolvingAI/hmengist/7.25/andxorand_hier/hier100/nn"+_postFix+".svg";
...
for (it =results.begin();it!=results.end();++it)
    ...
    sol.open("/project/EvolvingAI/hmengist/7.25/andxorand_hier/hier100/solvent.txt",std::fstream::out | std::fstream::app);
    sol <<"nn"+_postFix<<" "<<results.size()/number_problems<<"\n";
    sol.close();
    std::ofstream ofs("/project/EvolvingAI/hmengist/7.25/andxorand_hier/hier100/nn"+_postFix+".dot");
    indiv.nn().write(ofs);
