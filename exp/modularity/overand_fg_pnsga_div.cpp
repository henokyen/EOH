...
#define PNSGA
#define DIV
#line 1 "/home/hmengist/sferes/sferes2/trunk/exp/modularity/overand.cpp"
 //#define NO_PaRALLEL
#include <iostream>
#include <bitset>
...
static float pressure;
    ...
    struct dnn
    {
      ...
      struct spatial
      {
        SFERES_ARRAY(int, layers, 4, 3, 3, 2, 1);
    ...
    struct fitness
    {
      static const size_t b_size = 16 * Params::dnn::nb_outputs;
    };
  };
  ) // end of params
  ...
  public:
    ...
    void eval(Indiv& ind)
    {
      ...
      for (size_t s = 0; s < k; ++s)
      {
        ...
        for (size_t i = 0; i < Params::dnn::nb_inputs-1; i += 1)
        ...
        for (size_t i = 0; i < Params::dnn::nb_outputs; ++i)
         ...
         // errors
         and_res.push_back(and_res[0] ^ and_res[1]);
         and_res.push_back(and_res[1] ^ and_res[2]);
        if (and_res[3] && and_res[4])
