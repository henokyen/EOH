...
#define PR25
#define DIV
#line 1 "/home/hmengist/sferes/sferes2/trunk/exp/modularity/orxorand_evo.cpp"
#include <iostream>
#include <bitset>
#include<algorithm>
...
for (it =results.begin();it!=results.end();++it)
    ...
    sol.open("/project/evolutionaryRobotics/hmengist/7.25/andxorand/PCC100/PCCorxorand/solvent.txt",std::fstream::out | std::fstream::app);
    sol <<"nn"+_postFix<<" "<<results.size()/number_problems<<"\n";
    sol.close();
    std::ofstream ofs("/project/evolutionaryRobotics/hmengist/7.25/andxorand/PCC100/PCCorxorand/nn"+_postFix+".dot");
    indiv.nn().write(ofs);
