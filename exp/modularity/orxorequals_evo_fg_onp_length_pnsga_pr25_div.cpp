...
#define PR25
#define DIV
#line 1 "/home/hmengist/sferes/sferes2/trunk/exp/modularity/orxorequals_evo.cpp"
#include <iostream>
#include <bitset>
#include<algorithm>
...
template<typename Indiv>
 void eval(Indiv& ind)
  ...
  //std::string fname="/project/evolutionaryRobotics/hmengist/7.25/andxorand/PCC100/PCCorxorand/nn"+_postFix+".svg";
...
//	}
   ...
   //optimal length
      bool write_svg = (this->mode() == fit::mode::view);
      std::string fname="/project/evolutionaryRobotics/hmengist/7.25/andequalsand/PAe/PAorxorequalsevo/nn"+_postFix+".svg";
...
for (it =results.begin();it!=results.end();++it)
    ...
    sol.open("/project/evolutionaryRobotics/hmengist/7.25/andequalsand/PAe/PAorxorequalsevo/solvent.txt",std::fstream::out | std::fstream::app);
    sol <<"nn"+_postFix<<" "<<results.size()/number_problems<<"\n";
    sol.close();
    std::ofstream ofs("/project/evolutionaryRobotics/hmengist/7.25/andequalsand/PAe/PAorxorequalsevo/nn"+_postFix+".dot");
    indiv.nn().write(ofs);
...
tes.open("/project/evolutionaryRobotics/hmengist/7.25/andxorand/PA/test.txt",std::fstream::out | std::fstream::app);
...
std::vector<float> inputs(8);
std::fstream sol;
sol.open("/project/evolutionaryRobotics/hmengist/7.25/andxorand/PA/runPCC25_118/nn0336.txt",std::fstream::out | std::fstream::app);
