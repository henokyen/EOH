...
#define PNSGA
#define DIV
#line 1 "/home/hmengist/sferes/sferes2/trunk/exp/modularity/andequalsand_evo.cpp"
#include <iostream>
#include <bitset>
#include<algorithm>
...
//	}
   ...
   //optimal length
      bool write_svg = (this->mode() == fit::mode::view);
      std::string fname="/project/evolutionaryRobotics/hmengist/7.25/andxorand/PA/PAandequalsand/nn"+_postFix+".svg";
...
for (it =results.begin();it!=results.end();++it)
    ...
    sol.open("/project/evolutionaryRobotics/hmengist/7.25/andxorand/PA/PAandequalsand/solvent.txt",std::fstream::out | std::fstream::app);
    sol <<"nn"+_postFix<<" "<<results.size()/number_problems<<"\n";
    sol.close();                       
    std::ofstream ofs("/project/evolutionaryRobotics/hmengist/7.25/andxorand/PA/PAandequalsand/nn"+_postFix+".dot");
    indiv.nn().write(ofs);
